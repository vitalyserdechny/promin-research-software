...
class MaskRcnnDetector(ObjectDetector):
    """
    MaskRCNN detector class (derived from ObjectDetector)
    """ 
    def __init__(self):
        # Initializing Faster R-CNN model
        self.weights = MaskRCNN_ResNet50_FPN_Weights.DEFAULT
        self.model = maskrcnn_resnet50_fpn(weights=self.weights, box_score_thresh=0.5)
