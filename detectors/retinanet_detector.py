...
class RetinaNetDetector(ObjectDetector):
    """
    RetinaNET detector class (derived from ObjectDetector)
    """ 
    def __init__(self):
        # Initializing RetinaNET model
        self.weights = RetinaNet_ResNet50_FPN_Weights.DEFAULT
        self.model = retinanet_resnet50_fpn(weights=self.weights)
    ...
    def detect(self, image):
        """
        Detect objects in the given image using RetinaNET.
